...
class j00509western_union {
	function __construct($componentArgs)
		...
		$status = 'status=no,toolbar=yes,scrollbars=yes,titlebar=no,menubar=yes,resizable=yes,width=750,height=700,directories=no,location=no';
		...
		$pluginLink="<a class=\"btn btn-primary\" href=\"javascript:void window.open('".$link."', 'win2', '".$status."');\" title=\"".$plugin."\">".jr_gettext('COMMON_EDIT' , 'COMMON_EDIT' , false)." ".jr_gettext('_JRPORTAL_WESTERN_UNION' , '_JRPORTAL_WESTERN_UNION' , false)."</a>";
