...
class j00007subscriptions_gateway_western_union
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_gateway_westernunion";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"00509" => array("western_union"),
				"00510" => array("western_union"),
				"00605" => array("western_union"),
				"03108" => array("western_union")
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_COM_A_GATEWAYLIST", '_JOMRES_COM_A_GATEWAYLIST', false ).': '.jr_gettext("_JRPORTAL_WESTERN_UNION", '_JRPORTAL_WESTERN_UNION', false ),
			"friendlydesc" => "",
