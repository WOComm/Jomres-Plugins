...
class j06001undo_checkout 
	...
	function __construct()
		...
		$jomres_messaging->set_message("Undone booked guest out");
		jomresRedirect( jomresURL(JOMRES_SITEPAGE_URL."&task=edit_booking&contract_uid=".$contract_uid), "Undone booked guest out");
		}
