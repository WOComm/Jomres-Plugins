...
class j06001checkin 
	...
	function __construct()
		...
		jomresRedirect( jomresURL(JOMRES_SITEPAGE_URL."&task=edit_booking&contract_uid=".$contract_uid),  jr_gettext('_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN','_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN',false ) );
		}
