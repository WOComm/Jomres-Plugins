...
{	
	...
	public function __construct()
	{
		...
		$checkout_session = $stripe->checkout->sessions->create([
			'success_url' =>  JOMRES_SITEPAGE_URL_NOSEF.'&task=stripe_standard_callback&booking_id='.$tmpBookingHandler->tmpbooking['booking_number'],
			'cancel_url' =>  JOMRES_SITEPAGE_URL_NOSEF.'&task=stripe_standard_callback&booking_id='.$tmpBookingHandler->tmpbooking['booking_number'],
			'line_items' => [[
				'price_data' => [
		...
		$tmpBookingHandler->tmpbooking['stripe_standard_payment_intent'] = $checkout_session->payment_intent;
