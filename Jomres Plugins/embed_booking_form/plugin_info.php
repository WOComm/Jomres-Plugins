...
class plugin_info_embed_booking_form
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>'1.1 layout tweaks. 1.2 updated to work on Jr7 v1.3  Templates bootstrapped. 1.4 updated to work with Jr7.1. v1.5 Added BS3 templates. v1.6 Updated so that the property uid is shown in the embed code. v1.7 PHP7 related maintenance. v1.8 Jomres 9.7.4 related changes v1.9 Jomres 9.7.4 related changes v2.0 Remaining globals cleanup and jr_gettext refactor related changes. v2.1 template improvements. v2.2 Notices fixes. v2.3 Modified functionality to use new get_booking_url function. v2.4 Menu options updated for menu refactor in v9.8.30 v2.5 Removed a check for admin area to allow scripts to call frontend menu in the administrator area. v2.6 French language file added. v2.7 BS4 template set added v2.8 Italian language file added, thanks Nicola v2.9 Language files updated. v3.0 Bootstrap 5 template set added. v3.1 Serbian lang file updated.',
			'highlight'=>'',
