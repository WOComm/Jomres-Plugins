...
class j06001overview_checkouts
	{
	function __construct( $componentArgs )
		...
		$output['PAGETITLE'] = jr_gettext( '_JOMRES_HOVERVIEW_CHECKOUTS', '_JOMRES_HOVERVIEW_CHECKOUTS', false );
		...
		$output['AJAX_URL']=JOMRES_SITEPAGE_URL_AJAX."&task=overview_checkouts_ajax";
		...
		if (!$is_widget) {
			$tmpl->readTemplatesFromInput( 'overview_checkouts.html');
		} else {
			$tmpl->readTemplatesFromInput( 'widget_overview_checkouts.html');
		}
