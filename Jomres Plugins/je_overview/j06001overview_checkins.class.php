...
class j06001overview_checkins
	...
	function __construct( $componentArgs )
		...
		$output['PAGETITLE'] = jr_gettext( '_JOMRES_HOVERVIEW_CHECKINS', '_JOMRES_HOVERVIEW_CHECKINS', false );
		...
		$output['AJAX_URL']=JOMRES_SITEPAGE_URL_AJAX."&task=overview_checkins_ajax";
		...
		if (!$is_widget) {
			$tmpl->readTemplatesFromInput( 'overview_checkins.html');
		} else {
			$tmpl->readTemplatesFromInput( 'widget_overview_checkins.html');
		}
