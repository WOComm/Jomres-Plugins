...
class plugin_info_je_iframe_content_tab
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v2.1 Menu options updated for menu refactor in v9.8.30 v2.2 Modified how array contents are checked. v2.3 Removed a check for admin area to allow scripts to call frontend menu in the administrator area. v2.4 CSRF hardening added. v2.5 French language file added v BS4 template set added v2.6 Language files updated v2.7 Bootstrap 5 template set added. v2.8 Serbian lang file updated.' ,
			'highlight'=>'',
