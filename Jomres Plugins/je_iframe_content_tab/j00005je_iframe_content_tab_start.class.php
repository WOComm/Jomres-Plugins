...
class j00005je_iframe_content_tab_start {
	function __construct($componentArgs)
		...
		require_once($ePointFilepath."je_iframe_content_tab.class.php");
		...
		if ($thisJRUser->accesslevel >= 70) 
			{
			$jomres_menu->add_item(80, jr_gettext('_JRPORTAL_JE_IFRAME_CONTENT_TAB_TITLE', '_JRPORTAL_JE_IFRAME_CONTENT_TAB_TITLE', false), 'je_iframe_content_tab', 'fa-link');
			}
		}
