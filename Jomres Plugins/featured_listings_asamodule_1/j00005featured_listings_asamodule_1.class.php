...
class j00005featured_listings_asamodule_1 {
	function __construct()
		...
		if ($thisJRUser->accesslevel >= 90) 
			{
			$jomres_menu->add_item(70, jr_gettext('_JRPORTAL_FEATUREDLISTINGS_ASAMODULE_TITLE_A', '_JRPORTAL_FEATUREDLISTINGS_ASAMODULE_TITLE_A', false), 'featured_listings_asamodule_1', 'fa-star');
			}
		}
