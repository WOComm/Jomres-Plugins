...
class j00005location_station
	...
	function __construct()
		...
		$jomres_menu->add_admin_item(50, jr_gettext('_JOMRES_LOCATION_STATION_TITLE', '_JOMRES_LOCATION_STATION_TITLE', false), $task = 'location_station', 'fa-list');
		}
