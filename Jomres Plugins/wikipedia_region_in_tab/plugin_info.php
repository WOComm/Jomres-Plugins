...
class plugin_info_wikipedia_region_in_tab
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v1.1 Jomres 9.7.4 related changes & SSL tweaks v1.2 Remaining globals cleanup and jr_gettext refactor related changes. v1.3 jr_gettext tweaks. v1.4 French language file added v1.5 Language files updated',
			'highlight'=>'',
