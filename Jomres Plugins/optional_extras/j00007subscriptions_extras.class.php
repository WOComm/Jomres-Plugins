...
// ################################################################
class j00007subscriptions_extras
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_extras";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06002" => array("publish_extra","list_extras","edit_extra","save_extra","delete_extra") 
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_COM_MR_EXTRA_TITLE", '_JOMRES_COM_MR_EXTRA_TITLE', false ),
			"friendlydesc" => "",
