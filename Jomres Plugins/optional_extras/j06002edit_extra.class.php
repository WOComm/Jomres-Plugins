...
class j06002edit_extra {
    function __construct()
    {
        ...
        $jrtb .= $jrtbar->toolbarItem('save','','',true,'save_extra');
        $jrtb .= $jrtbar->toolbarItem('cancel',jomresURL(JOMRES_SITEPAGE_URL."&task=list_extras"),'');
        ...
        $force=0;
        $output['EXTRAMODEL_FORCE1']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE2']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE3']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE4']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE5']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE6']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE7']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE8']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE9']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        $output['EXTRAMODEL_FORCE100']	=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $force );
        ...
        if ($uid>0)
        {
            ...
            switch ($model['model'])
            {
                case '1':
                    ...
                    $output['EXTRAMODEL_FORCE1']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '2':
                    $output['EXTRAMODEL_PERDAYS_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE2']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '3':
                    $output['EXTRAMODEL_PERBOOKING_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE3']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '4':
                    $output['EXTRAMODEL_PERPERSONPERBOOKING_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE4']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '5':
                    $output['EXTRAMODEL_PERPERSONPERDAY_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE5']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '6':
                    $output['EXTRAMODEL_PERPERSONPERWEEK_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE6']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '7':
                    $output['EXTRAMODEL_PERDAYSMINDAYS_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE7']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    $mindays=$model['params'];
                    break;
                case '8':
                    $output['EXTRAMODEL_PERDAYSPERROOM_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE8']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '9':
                    $output['EXTRAMODEL_PERROOMPERBOOKING_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE9']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
                case '100':
                    $output['EXTRAMODEL_COMMISSION_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE100']=jomresHTML::selectList( $yesno, 'force[100]', ' ', 'value', 'text', $model['force'] , false );
                    break;
            }

            $query = $query="SELECT `name`,`desc`,`price`,`auto_select`,`tax_rate`,`maxquantity`, DATE_FORMAT(`validfrom`, '%Y/%m/%d') AS validfrom,DATE_FORMAT(`validto`, '%Y/%m/%d') AS validto,`include_in_property_lists`,`limited_to_room_type` FROM `#__jomres_extras` WHERE uid = '".(int)$uid."' AND property_uid = '".(int)$defaultProperty."'";
            ...
            foreach($exList as $ex)
            {
                ...
                $output['MAXQUANTITYDROPDOWN']			= jomresHTML::integerSelectList( 01, 1000, 1, "maxquantity", '', $ex->maxquantity, "%02d" );
                $output['TAXRATEDROPDOWN']				= $jrportal_taxrate->makeTaxratesDropdown( $ex->tax_rate );
                $output['AUTO_SELECT']					= jomresHTML::selectList( $yesno, 'auto_select', ' ', 'value', 'text', $ex->auto_select );
                ...
                $output['INCLUDE_IN_PROPERTY_LISTS']	= jomresHTML::selectList( $yesno, 'include_in_property_lists', ' ', 'value', 'text', $ex->include_in_property_lists );
                if ( count ($room_type_dropdown_contents) > 0)
                    $output['ROOMTYPEDROPDOWN']				= jomresHTML::selectList($room_type_dropdown_contents, 'limited_to_room_type', ' ', 'value', 'text', $ex->limited_to_room_type);
            }
        }
        else
        {
            $output['EXTRAMODEL_PERWEEK_CHECKED']	= "checked";
            $output['MAXQUANTITYDROPDOWN']			= jomresHTML::integerSelectList( 01, 1000, 1, "maxquantity", '', 1, "%02d" );
            $output['TAXRATEDROPDOWN']				= $jrportal_taxrate->makeTaxratesDropdown( $mrConfig['accommodation_tax_code'] );
            $model['model']							= 2;
            $model['force']							= 0;
            $output['AUTO_SELECT']					= jomresHTML::selectList( $yesno, 'auto_select', ' ', 'value', 'text', 0 );
            $output['INCLUDE_IN_PROPERTY_LISTS']	= jomresHTML::selectList( $yesno, 'include_in_property_lists', ' ', 'value', 'text', 1 );
            if ( count ($room_type_dropdown_contents) > 0)
                $output['ROOMTYPEDROPDOWN']				= jomresHTML::selectList($room_type_dropdown_contents, 'limited_to_room_type', ' ', 'value', 'text', 0 );
            ...
            switch ($model['model'])
            {
                ...
                case '100':
                    $output['EXTRAMODEL_COMMISSION_CHECKED']="checked";
                    $output['EXTRAMODEL_FORCE100']=jomresHTML::selectList( $yesno, 'force[]', ' ', 'value', 'text', $model['force'] );
                    break;
            }
