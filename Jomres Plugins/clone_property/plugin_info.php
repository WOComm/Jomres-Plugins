...
class plugin_info_clone_property
	...
	function __construct()
		...
		$this->data=array(
			...
			"version"=>(float)"5.0",
			"description"=> " Clones one property's settings to a new property. Does not clone tariffs, you will need to use the Clone Tariff plugin to populate the tariffs for the newly created property (or create the tariffs manually). v3.2 Fixed an issue where Jintour property room was not added for the purpose of searching. ",
