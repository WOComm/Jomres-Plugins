...
class j00005clone_property {
	function __construct()
		...
		$jomres_menu->add_admin_item(70, jr_gettext('_JRPORTAL_CLONEPROPERTY_TITLE', '_JRPORTAL_CLONEPROPERTY_TITLE', false), $task = 'clone_property', 'fa-files-o');
		}
