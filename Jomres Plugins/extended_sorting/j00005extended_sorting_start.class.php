...
class j00005extended_sorting_start {
	function __construct($componentArgs)
		...
		$obsolete_plugin_files[] = get_showtime('ePointFilepath').'j01009filterproperties.class.php';
		$obsolete_plugin_files[] = get_showtime('ePointFilepath').'j00001extended_sorting_start.class.php';
