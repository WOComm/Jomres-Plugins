...
class j00005clear_sessions {
	function __construct()
		...
		$jomres_menu->add_admin_item(70, jr_gettext('_JRPORTAL_CLEAR_SESSIONS_TITLE', '_JRPORTAL_CLEAR_SESSIONS_TITLE', false), $task = 'clear_sessions', 'fa-files-o');
		}
