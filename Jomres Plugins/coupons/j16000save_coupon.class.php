...
class j16000save_coupon {
	function __construct()
		...
		jomresRedirect( jomresURL(JOMRES_SITEPAGE_URL_ADMIN."&task=list_coupons"), jr_gettext('_JOMRES_MR_AUDIT_UPDATE_COUPON','_JOMRES_MR_AUDIT_UPDATE_COUPON',FALSE));
		}
