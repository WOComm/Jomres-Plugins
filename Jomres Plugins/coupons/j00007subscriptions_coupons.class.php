...
class j00007subscriptions_coupons
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_coupons";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06002" => array("deleteCoupon","editCoupon","listCoupons","saveCoupon","print_coupons")
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JRPORTAL_COUPONS_TITLE", '_JRPORTAL_COUPONS_TITLE', false ),
			"friendlydesc" => "",
