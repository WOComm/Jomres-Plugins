...
class plugin_info_comments_tab_disqus
	...
	function __construct()
		...
		$this->data=array(
			...
			"version"=>(float)"2.3",
			"description"=> "Adds a Disqus comment tab to the property details page.",
