...
class plugin_info_number_of_properties
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>'v1.1 Fixed an error that can result in Property uid not recognised error emails. v1.2 PHP7 related maintenance. v1.3 Jomres 9.7.4 related changes v1.4 Remaining globals cleanup and jr_gettext refactor related changes. v1.5 French language file added v1.6 BS4 template set added v1.7 Italian language file added, thanks Nicola v1.8 Language files updated v1.9 Bootstrap 5 template set added. v2.0 Documentation updated',
			'highlight'=>'',
