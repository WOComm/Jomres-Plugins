...
class plugin_info_jomres_selfregister_asamodule
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>'v1.1 PHP7 related maintenance. v1.2 Jomres 9.7.4 related changes v1.3 Remaining globals cleanup and jr_gettext refactor related changes. v1.4 New property link updated. v1.5 Settings moved to Site Config. v1.6 French language file added v1.7 BS4 template set added v1.8 Language files updated v1.9 Documentation updated',
			'highlight'=>'',
