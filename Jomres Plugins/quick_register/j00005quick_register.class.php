...
class j00005quick_register
	...
	function __construct($componentArgs)
		...
		if (isset($jomres_menu->items['cms_user_login']))
			{
			unset($jomres_menu->items['cms_user_login']);
			}
		
		if (isset($jomres_menu->items['cms_user_register']))
			{
			unset($jomres_menu->items['cms_user_register']);
			}
		}
