...
class j00005search_form_elements_forms
	{
	function __construct()
		...
		if (file_exists(get_showtime('ePointFilepath').'language'.JRDS.get_showtime('lang').'.php'))
			...
			$jomres_menu->add_admin_item(70, jr_gettext('_JOMRES_SEARCH_FORM_ELEMENTS_FORMS_TITLE', '_JOMRES_SEARCH_FORM_ELEMENTS_FORMS_TITLE', false), $task = 'search_form_elements_forms', 'far fa-file');
		}
