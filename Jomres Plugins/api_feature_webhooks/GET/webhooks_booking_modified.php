...
/*
	** Title | Webhooks Booking Amend
	** Description | Designed to allow remote services that have received a webhook notification to call the Jomres installation back and request information about the update.
	** Plugin | api_feature_webhooks
	** Scope | webhooks_get
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/booking_modified/:CONTRACT_UID
	...
	** Error Response | 
	** Sample call |jomres/api/webhooks/1/booking_modified/41
	** Notes | Replies with the booking details from the query
*/

Flight::route('GET /webhooks/@id/booking_modified/@contract_uid', function($property_uid , $contract_uid)
	{
