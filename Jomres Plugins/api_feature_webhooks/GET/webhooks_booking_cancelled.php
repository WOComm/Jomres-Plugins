...
/*
	** Title | Webhooks Booking Cancel
	** Description | Responds with booking details of cancelled booking
	** Plugin | api_feature_webhooks
	** Scope | webhooks_get
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/booking_cancelled/:CONTRACT_UID
	...
	** Error Response | 
	** Sample call |jomres/api/webhooks/1/booking_cancelled/37
	** Notes | Replies with the booking details from the query
*/

Flight::route('GET /webhooks/@id/booking_cancelled/@contract_uid', function($property_uid , $contract_uid)
	{
