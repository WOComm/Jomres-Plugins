...
/*
	...
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/property_saved
	...
	** Sample call |jomres/api/webhooks/1/property_saved
	** Notes | Replies with the details of the property
*/

Flight::route('GET /webhooks/@id/property_saved', function($property_uid)
	{
