...
/*
	** Title | Webhooks Guest Checked out
	** Description | Notifies remote services that a guest's checked out status has been reversed
	** Plugin | api_feature_webhooks
	** Scope | webhooks_get
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/guest_checkedout_undone/:CONTRACT_UID
	...
	** Error Response | 
	** Sample call |jomres/api/webhooks/1/guest_checkedout_undone/41
	** Notes | Replies with the booking details from the query
*/

Flight::route('GET /webhooks/@id/guest_checkedout_undone/@contract_uid', function($property_uid , $contract_uid)
	{
