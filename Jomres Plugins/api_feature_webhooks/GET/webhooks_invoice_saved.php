...
/*
	** Title | Webhooks Invoice Added/Updated
	** Description | Responds with details of added/modified invoice. I
	** Plugin | api_feature_webhooks
	** Scope | webhooks_get
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/invoice_saved/:INVOICE_UID
	...
	** Sample call |jomres/api/webhooks/1/invoice_saved/37
	** Notes | Replies with the details of the invoice
*/

Flight::route('GET /webhooks/@id/invoice_saved/@invoice_uid', function($property_uid , $invoice_uid)
	{
