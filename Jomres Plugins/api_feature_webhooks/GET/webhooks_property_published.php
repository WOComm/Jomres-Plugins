...
/*
	...
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/property_published
	...
	** Sample call |jomres/api/webhooks/1/property_published
	** Notes | Replies with the details of the property
*/

Flight::route('GET /webhooks/@id/property_published', function($property_uid)
	{
