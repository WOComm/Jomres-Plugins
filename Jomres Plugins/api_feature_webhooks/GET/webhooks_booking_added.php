...
/*
	** Title | Webhooks Booking Add
	** Description | Responds with booking details of newly created bookings
	** Plugin | api_feature_webhooks
	** Scope | webhooks_get
	** URL | webhooks
 	** Method | GET
	** URL Parameters | webhooks/:ID/booking_added/:CONTRACT_UID
	...
	** Error Response | 
	** Sample call |jomres/api/webhooks/1/booking_added/41
	** Notes | Replies with the booking details from the query
*/

Flight::route('GET /webhooks/@id/booking_added/@contract_uid', function($property_uid , $contract_uid)
	{
