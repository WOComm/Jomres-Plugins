...
class j03200mollie
{
	function __construct($componentArgs)
	{
		...
		if (!isset($tmpBookingHandler->tmpbooking['mollie_invoice_id'])) { // This payment isn't for Mollie payments
			return;
		}
		...
		$line_items = array('tax_code_id' => 0,
			...
			'transaction_id' => $tmpBookingHandler->tmpbooking['mollie_invoice_id']
		);
