...
* @version Jomres 9 
* @package Jomres
* @copyright	2005-2021 Woollyinwales IT
...
class plugin_info_custom_property_fields
	...
	function __construct()
		...
		$this->data=array(
			...
			"version"=>(float)"6.8",
			"description"=> " Allows you to add custom fields in the administrator area (via a new button 'custom property fields'). This allows property managers to add information extra to that normally recorded by the edit property details page. This data is added to a new tab in the property details page, however you must edit the tabcontent_01_custom_property_fields.html yourself, sample data is provided that uses the fields that you create to build the template contents. Warning : To use this plugin you need to customise the tabcontent_01_custom_property_fields.html template file, however if you upgrade this plugin then that file will be overwritten, so please ensure that you have backed it up before upgrading this plugin.",
