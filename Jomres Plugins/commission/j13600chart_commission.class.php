...
class j13600chart_commission
	...
	function __construct($componentArgs)
		...
		$all_jomres_charts[] = array(
									 "id" => 'chart_commission',
									 "title"=>jr_gettext("_JOMRES_COMMISSION",'_JOMRES_COMMISSION',false,false),
									 "description"=> jr_gettext("_JOMRES_CHART_COMMISSION_DESC",'_JOMRES_CHART_COMMISSION_DESC',false,false)
									 );
