...
//This is a month view chart of all paid commissions, excludes cancelled/pending/unpaid ones)
class j16000chart_commission
	{
	function __construct($componentArgs)
		...
		$chart->title 		= jr_gettext("_JOMRES_COMMISSION",'_JOMRES_COMMISSION',false,false);
		$chart->url 		= jomresUrl(JOMRES_SITEPAGE_URL_ADMIN . '&task=charts&jr_chart=chart_commission');
		$chart->title_class = 'panel-default';
		$chart->description = jr_gettext("_JOMRES_CHART_COMMISSION_DESC",'_JOMRES_CHART_COMMISSION_DESC',false,false);
