...
// ################################################################
	...
	Flight::route('GET /booking/ok_to_book', function()
	{
		...
		$ok_to_book = (bool)$nbe->TempBookingHandler->getBookingData('ok_to_book');
		$nbe->save_session();
		Flight::json( "ok_to_book" , [ 'response' => $ok_to_book ] );
