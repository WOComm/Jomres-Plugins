...
class j00007subscriptions_gateway_paypal
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_gateway_paypal";
		...
		$subscribable_features [ $feature_name ] = array (
			...
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_COM_A_GATEWAYLIST", '_JOMRES_COM_A_GATEWAYLIST', false ).': '.jr_gettext("_JOMRES_COM_A_PAYPAL", '_JOMRES_COM_A_PAYPAL', false ),
			"friendlydesc" => "",
