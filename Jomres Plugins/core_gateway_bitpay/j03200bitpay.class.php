...
class j03200bitpay
{
	function __construct($componentArgs)
	{
		...
		if (!isset($tmpBookingHandler->tmpbooking['bitpay_invoice_id'])) { // This payment isn't for Bitpay payments
			return;
		}
		...
		$line_items = array('tax_code_id' => 0,
			...
			'transaction_id' => $tmpBookingHandler->tmpbooking['bitpay_invoice_id']
		);
