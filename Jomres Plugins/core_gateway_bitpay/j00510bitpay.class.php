...
class j00510bitpay {
	function __construct()
		...
		$output['BITPAY_API_TOKEN_TITLE']		= jr_gettext('BITPAY_API_TOKEN_TITLE','BITPAY_API_TOKEN_TITLE');
		$output['BITPAY_TEST_API_TOKEN_TITLE']	= jr_gettext('BITPAY_TEST_API_TOKEN_TITLE','BITPAY_TEST_API_TOKEN_TITLE');
		$output['BITPAY_API_TOKEN_DESC']		= jr_gettext('BITPAY_API_TOKEN_DESC','BITPAY_API_TOKEN_DESC');
		$output['BITPAY_API_TEST_MODE']			= jr_gettext('BITPAY_API_TEST_MODE','BITPAY_API_TEST_MODE');
		$output['BITPAY_API_TEST_MODE_DESC']	= jr_gettext('BITPAY_API_TEST_MODE_DESC','BITPAY_API_TEST_MODE_DESC');
		$output['COMMON_SUBMIT']				= jr_gettext('COMMON_SUBMIT','COMMON_SUBMIT');
		$output['GATEWAY']						= 'bitpay';
