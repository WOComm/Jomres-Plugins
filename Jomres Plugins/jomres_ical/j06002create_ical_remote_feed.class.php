...
class j06002create_ical_remote_feed
	{
	function __construct($componentArgs)
		...
		$output['ROOM_TYPE_DROPDOWN'] = jomresHTML::selectList( $options, 'room_uid', ' ', 'value', 'text', '' );
		
		$output['_JOMRES_ICAL_SELECT'] = jr_gettext('_JOMRES_ICAL_REMOTE_FEED_URL','_JOMRES_ICAL_REMOTE_FEED_URL',false,false);
		$output['_JOMRES_ICAL_IMPORT_INFO'] = jr_gettext('_JOMRES_ICAL_REMOTE_INFO','_JOMRES_ICAL_REMOTE_INFO',false,false);
		...
		$jrtb .= $jrtbar->toolbarItem('save','','',true,'save_ical_remote_feed');
		...
		$tmpl->readTemplatesFromInput( "create_ical_remote_feed.html" );
