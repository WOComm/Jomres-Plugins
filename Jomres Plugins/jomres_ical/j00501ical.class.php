...
class j00501ical
	...
	function __construct( $componentArgs )
		...
		if (!isset($mrConfig[ 'iCalIncludeEnquiries' ])) {
			$mrConfig[ 'iCalIncludeEnquiries' ] = '0';
		}
		
		if (!isset($mrConfig[ 'iCalAnonymousFeed' ])) {
			$mrConfig[ 'iCalAnonymousFeed' ] = '0';
		}
		
		$iCalIncludeEnquiries = jomresHTML::selectList( $yesno, 'cfg_iCalIncludeEnquiries', ' ', 'value', 'text', $mrConfig[ 'iCalIncludeEnquiries' ] );
		$iCalAnonymousFeed = jomresHTML::selectList( $yesno, 'cfg_iCalAnonymousFeed', ' ', 'value', 'text', $mrConfig[ 'iCalAnonymousFeed' ] );
