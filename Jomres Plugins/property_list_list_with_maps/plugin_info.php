...
class plugin_info_property_list_list_with_maps
	...
	function __construct()
		...
		$this->data=array(
			...
			"marketing"=>"Identical to the standard property list, but puts a small Google map next to the price output in the property list. Bootstrap 2 & 3 only, not Bootstrap 5.",
			"version"=>"3.5",
