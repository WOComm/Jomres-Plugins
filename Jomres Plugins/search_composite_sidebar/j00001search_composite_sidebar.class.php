...
class j00001search_composite_sidebar
{
    public function __construct()
    {
		...
		$this_plugin = "template_package_plugin_override_test";
		...
		$template_packages[$this_plugin][] = array (
			"template_name"=>"ajax_search_composite_multiselect.html",
			"title"=>"Ajax search > Vertical sidebar multiselect",
			"description"=>"",
			"screenshot"=>"",
			"path"=>$template_path);
