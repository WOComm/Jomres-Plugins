...
class j16000chart_subscriptions
	{
	function __construct($componentArgs)
		...
		$chart->title 		= jr_gettext("_JOMRES_STATUS_SUBSCRIPTIONS",'_JOMRES_STATUS_SUBSCRIPTIONS',false,false);
		$chart->url 		= jomresUrl(JOMRES_SITEPAGE_URL_ADMIN . '&task=charts&jr_chart=chart_subscriptions');
		$chart->title_class = 'panel-default';
		$chart->description = jr_gettext("_JOMRES_CHART_SUBSCRIPTIONS_DESC",'_JOMRES_CHART_SUBSCRIPTIONS_DESC',false,false);
