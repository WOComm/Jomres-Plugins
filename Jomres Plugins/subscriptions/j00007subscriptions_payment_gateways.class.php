...
class j00007subscriptions_payment_gateways
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_payment_gateways";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06002" => array("payment_gateways", "editGateway", "save_plugin"),
				"06000" => array()
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_COM_A_GATEWAYLIST", '_JOMRES_COM_A_GATEWAYLIST', false ),
			"friendlydesc" => "",
