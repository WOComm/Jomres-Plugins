...
class j00007subscriptions_api
	...
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_api";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06005" => array("oauth", "oauth_authorise", "oauth_edit_client", "save_client", "delete_client"),
				"06000" => array("api_documentation")
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JRPORTAL_SUBSCRIPTIONS_PACKAGES_APIACCESS", '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_APIACCESS', false ),
			"friendlydesc" => "",
