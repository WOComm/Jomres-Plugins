...
class j00007subscriptions_ical
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_ical";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06002" => array("create_ical_remote_feed", "delete_ical_remote_feed", "ical_export_contract", "ical_feeds" , "ical_import" , "ical_import_file" , "list_ical_remote_feeds" , "save_ical_remote_feed" ),
				"06000" => array()
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_ICAL_FEEDS", '_JOMRES_ICAL_FEEDS', false ),
			"friendlydesc" => "",
