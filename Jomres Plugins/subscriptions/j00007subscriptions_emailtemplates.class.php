...
class j00007subscriptions_emailtemplates
	{
	function __construct( $componentArgs )
		...
		$feature_name = "subscriptions_emailtemplates";
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"06002" => array("list_emails", "edit_emails", "save_email")
				),
			"name" => $feature_name,
			"friendlyname" => jr_gettext("_JOMRES_EMAIL_TEMPLATES_TITLE", '_JOMRES_EMAIL_TEMPLATES_TITLE', false ),
			"friendlydesc" => "",
