...
class j00005defaultPropertySettings_start {
	function __construct($componentArgs)
		...
		$jomres_menu->add_admin_item(90, jr_gettext('_JRPORTAL_DEFAULT_PROPERTY_SETTINGS_TITLE', '_JRPORTAL_DEFAULT_PROPERTY_SETTINGS_TITLE', false), $task = 'defaultPropertySettings', 'fa-cog');
		}
