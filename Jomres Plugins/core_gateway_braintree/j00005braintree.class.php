...
/*		if (get_showtime('task') == 'processpayment' && !defined('BRAINTREE_JS_SHOWN') ) {
			echo '<script src="https://bitpay.com/bitpay.min.js"></script>';
			define('BRAINTREE_JS_SHOWN',1);
		}*/
	}
