...
class plugin_info_bitly
	...
	function __construct()
		...
		$this->data=array(
            ...
            "lastupdate"=>"2021/10/14",
			"min_jomres_ver"=>"9.8.30",
			"manual_link"=>'http://www.jomres.net/manual/site-managers-guide/15-core-plugins/303-twitter',
			'change_log'=>'v1.0 PHP7 related maintenance. v1.1 Jomres 9.7.4 related changes v1.2 Remaining globals cleanup and jr_gettext refactor related changes. v1.3 Fixed some notice level errors. v1.4 Plugin revampled. v1.5 Site Config tab updates. v1.6 French language file added. v1.7 Language files updated',
			'highlight'=>'',
