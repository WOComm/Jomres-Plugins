...
class j00005agent_page_start
	...
	function __construct()
		...
		if ($thisJRUser->accesslevel >= 50) {
			...
			$jomres_menu->add_item(10, jr_gettext('_JOMRES_AGENT_PAGE', '_JOMRES_AGENT_PAGE', false), $task = 'view_agent&id='.$thisJRUser->id, 'fa-id-card-o');
		}
