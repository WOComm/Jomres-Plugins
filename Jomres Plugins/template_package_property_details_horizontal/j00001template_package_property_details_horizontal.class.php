...
class j00001template_package_property_details_horizontal
{
    public function __construct()
    {
		...
		$template_packages[$this_plugin][] = array (
			...
			"title"=>"Property details > Horizontal layout",
			"description"=>"",
			"screenshot"=>"",
			"path"=>$template_path);
		$template_packages[$this_plugin][] = array (
			"template_name"=>"tabcontent_01_more_info.html",
			"title"=>"Property details > More Info panel, horizontal",
			"description"=>"",
			"screenshot"=>"",
			"path"=>$template_path);
