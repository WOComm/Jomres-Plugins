...
jr_define ('BEDS24V2_CHANNEL_MANAGEMENT', 'Kanal İdarəçiliyi (Beds24)');

jr_define ('BEDS24V2_WEBHOOKS_AUTH_METHOD', 'Beds24');
jr_define ('BEDS24V2_WEBHOOKS_AUTH_METHOD_NOTES', 'Beds24 hesabınız varsa və sifarişiniz olduqda Beds24 -ü yeniləmək istəyirsinizsə, bu seçimi seçin. URL -ni https://www.beds24.com/api/json/ olaraq təyin edin');
jr_define ('BEDS24V2_ERROR_USER_NO_KEY', 'Bu istifadəçinin heç bir API açarı yoxdur, buna görə də davam edə bilməz. Zəhmət olmasa İstifadəçi İdarəçiliyi> Əmlak menecerləri səhifəsindəki səhifəsinə daxil olun və həmin səhifədə verilən bağlantıdan istifadə edərək yeni API açarı yaradın.');
jr_define ('BEDS24V2_ERROR_USER_NO_PROPERTIES', 'Bu istifadəçinin Beds24 xüsusiyyətlərinə təyin edə biləcəyi Jomres xüsusiyyətləri yoxdur və ya əksinə');
jr_define ('BEDS24V2_NOT_SUBSCRIBED', "Daxil olduğunuz menecerin Beds24 -də heç bir hesabının olmadığı göründüyü üçün əvvəlcə onların xidməti üçün qeydiyyatdan keçməlisiniz, sonra bu API açarını <a href = 'https://www.beds24.com/control2.php?pagetype=accountpassword' target='_blank'> Beds24 -in veb saytı burada. </a> ");
jr_define ('BEDS24V2_NOT_SUBSCRIBED_KEY', "Davam etmək üçün bu API açarını Beds24 hesabınızdakı LINK sahəsinə kopyalayın və yapışdırın.");
jr_define ('BEDS24V2_NOT_SUBSCRIBED_RELOAD', "Bunu etdikdən sonra davam etmək üçün aşağıdakı düyməni basın.");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_TITLE', "Beds24 mülkiyyət əlaqələndirir");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_INFO', "Bu səhifə, bu sistemdə əldə edə biləcəyiniz mülkləri, üstəlik Kanal Menecerində olanları görməyə imkan verir. Bu da Kanal Yöneticisindən xassələri bu sistemə idxal etməyə və ya ixrac etməyə imkan verir. Mövcud xüsusiyyətlər Kanal Menecerinə verilir. <br/> Həm bu sistemdə, həm də Beds24 -də xüsusiyyətləriniz varsa və bunları bir -birinə bağlamaq istəyirsinizsə, bunu etmək üçün Əmlak apikeyindən istifadə edə bilərsiniz. Beds24> Ayarlar> Xüsusiyyətlər bölməsinə daxil olun. açılan menyuda seçdiyiniz əmlak əlaqələndirmək istədiyiniz ilə eynidir) sonra Bağlantı alt menyusunda Beds24dəki 'propKey' sahəsindəki 'Əmlak apikeyini' qeyd edin. Bunu etdikdən sonra səhifəni yenidən yükləyin. Bu sistem iki mülkün eyni açarla əlaqəli olduğunu görün və lazım olan assosiasiyalar yaradın. İki mülk əlaqələndirildikdən sonra, Baxış Mülkiyyət səhifəsinə daxil olmağı, bildiriş urlini tapmağı və Bağlantı səhifəsinin 'Url Bildir' sahəsinə yapışdırmağı unutmayın. O olacaq Rezervasyonları alanda Beds24 -ün bu əmlakı sinxronizasiya etmək üçün düzgün bağlantıdan istifadə etməsini təmin edin. ");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_NO_PROPERTIES', "Xəta: Beds24 -də əlaqələndirə biləcəyiniz heç bir xüsusiyyət yoxdur. Bunun səbəbi ola bilər ki, hüquqlarınız olan bütün mülklər artıq bu sistemdə başqa bir hesabla əlaqələndirilmişdir.");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_PROPERTY_UID', "Mülkiyyət uid");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_PROPERTY_NAME', "Mülkiyyət adı");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_BEDS24_PROPERTY_UID', "Beds24 Mülkiyyət İstifadəçisi");
jr_define ('BEDS24V2_DISPLAY_PROPERTIES_BEDS24_PROPERTY_NAME', "Beds24 Mülkiyyət Adı");
jr_define ('BEDS24V2_DISPLAY_PROPERTY_APIKEY', "Əmlak apikey");
jr_define ('BEDS24_LISTPROPERTIES_IMPORT', "İdxal");
jr_define ('BEDS24_LISTPROPERTIES_ASSOCIATE_ROOM_TYPES', "Otaq növlərini konfiqurasiya et");
jr_define ('BEDS24_LISTPROPERTIES_ASSOCIATE_ROOM_TYPES_DESC', "Beds24 hesabınızdakı otaq növlərini bu sistemdə saxlanılanlarla əlaqələndirməlisiniz.");
jr_define ('_BEDS24_DISPLAY_BOOKINGS_JOMRESROOMS_BEDS24TYPENAME', "Beds24 otaq tipi");

jr_define ('BEDS24_LISTPROPERTIES_IMPORT_CANNOT_NOAPIKEY', "Əmlak Açarı səhifəsində Əmlak Açarını təyin etmədiyiniz üçün bu əmlakı hələ də idxal edə bilməzsiniz.");
jr_define ('BEDS24_LISTPROPERTIES_IMPORT_CANNOT_NOROOMS', "Heç bir otağı olmadığı üçün bu əmlakı hələ də idxal etmək mümkün deyil. Zəhmət olmasa bir və ya daha çox otaq yaradın (Beds24dəki otaqlar Jomresdəki otaq tipləri ilə eynidir) və minimum qiyməti təyin etməyi unutmayın. . Bunu etdikdən sonra otaq tipini Jomres -ə idxal edə və mövcud Jomres otaq növləri ilə əlaqələndirə bilərsiniz. Bundan sonra tarifləri dəyişə biləcəksiniz, ancaq minimum qiymət təyin etmək lazımdır. ");
jr_define ('_BEDS24_SUGGESTED_KEY', "Bu API Açarını istifadə etməyi təklif edirik. Bunu etdikdən sonra bu səhifəni yenidən yükləyin.");
jr_define ('BEDS24_LISTPROPERTIES_EXPORT', "İxrac et");
jr_define ('BEDS24V2_REST_API_INTRO', "Burada REST API açar cütlüyünüzü və API -yə gedən yolu görə bilərsiniz. Bu məlumatları hesabınızda Beds24 -də saxlasanız, Beds24 24 bu API ilə API ilə əlaqə saxlaya biləcək.");
jr_define ('BEDS24V2_REST_API_CLIENT_ID', "Müştəri ID");
jr_define ('BEDS24V2_REST_API_CLIENT_SECRET', "Müştəri Sirri");
jr_define ('BEDS24V2_REST_API_ENDPOINT', "URI (son nöqtə)");
jr_define ('BEDS24_LISTPROPERTIES_CONFIGURE', "Əmlaka baxmaq");
jr_define ('BEDS24_ROOM_TYPES_TITLE', "Otaq tipli birliklər");
