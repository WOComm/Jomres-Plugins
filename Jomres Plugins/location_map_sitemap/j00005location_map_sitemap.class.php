...
class j00005location_map_sitemap {
	function __construct()
		...
		if ($thisJRUser->accesslevel >= 70) 
			...
			$jomres_menu->add_item(70, jr_gettext('_JOMRES_LOCATION_MAP_SITEMAP', '_JOMRES_LOCATION_MAP_SITEMAP', false), jomresUrl(JOMRES_SITEPAGE_URL.'&task=location_map&mm_plugin=location_map_sitemap'), 'fa-sitemap', true);
			}
		}
